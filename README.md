...
4. "Activate" товч дээр дарж модулийг идэвхжүүлнэ
...
- `amount_paid` талбар `store=True` тул өгөгдлийн санд хадгалагдах ба хурдан ажиллана
- Төлбөрийн түүх олох нь Odoo-ийн стандарт ORM арга ашигладаг тул үр ашигтай

### Аюулгүй Байдал

- Зөвхөн "Ерөнхий нягтлан бодогч" эрх бүхий хэрэглэгч дэлгэрэнгүй мэдээлэл харна
- Record rule болон access rights зөв тохируулагдсан
